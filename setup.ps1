...
Write-Host ""
Write-Host "Optional, to keep secrets in the Windows Credential Manager instead of a file"
Write-Host "(Gmail sync, publish passphrase and outreach read them from there):"
Write-Host "  pip install keyring; python -m jobscope secrets set JOBSCOPE_GMAIL_APP_PW"
Write-Host ""

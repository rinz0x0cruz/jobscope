// Lightweight, dependency-free SVG/CSS charts for the Overview lens. Token-driven
...
function Empty({ label }: { label: string }) {
  return (
    <div className="flex h-24 items-center justify-center text-sm text-ink-3">{label}</div>
  )
}
